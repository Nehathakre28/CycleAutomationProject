# Utility: 106_Cycle Script Standards.feature
# 
...
#
# Public Scenarios:
#	- Terminal Navigate Quickly to Undirected Menu - will navigate to the Undirected Menu from most Terminal screens
#   - Terminal Navigate to Load Equipment Menu - navigate to the Load Equipment Menu
#   - Terminal Navigate to LTL Load Menu -  navigate to the LTL Load Menu
# Assumptions:
# None
#
# Notes:
...
When I "navigate to the Shipment Menu"
	Once I see "Undirected Menu" in terminal
	If I verify text $term_type is equal to "handheld"
		Once I see cursor at line 12 column 15 in terminal
	Else I verify text $term_type is equal to "vehicle"
...
When I "validate we are on the LTL Loading screen"
